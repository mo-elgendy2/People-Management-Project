...
namespace People_Management__full_pro__1set
{
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        private void frmNewInternationalLicenseApplication_Load(object sender, EventArgs e)
        {
            ...
            lblFees.Text = ClsAppTypes.Find((int)clsApplictions.enApplicationType.NewInternationalLicense).Fees.ToString();
        ...
        private void btnIssueLicense_Click(object sender, EventArgs e)
        {
           ...
           clsInternationalLicense InternationalLicense= new clsInternationalLicense();
            ...
            InternationalLicense.applcatonStatus = clsApplictions.enApplicationStatus.Completed;
            InternationalLicense.LastStatusDate = DateTime.Now;
            InternationalLicense.PaidFees = ClsAppTypes.Find((int)clsApplictions.enApplicationType.NewInternationalLicense).Fees;
            InternationalLicense.CreatByUserId = clsGlobal.CurrentUser.UserID;

...
using static bescnesLayer.clsLicense;
    ...
    public partial class frmReplaceLostOrDamagedLicenseApplication : Form
    {
        ...
        private int _GetApplicationTypeID()
        {
            ...
            if (rbDamagedLicense.Checked)
                ...
                return (int)clsApplictions.enApplicationType.ReplaceDamagedDrivingLicense;
            else
                return (int)clsApplictions.enApplicationType.ReplaceLostDrivingLicense;
        }
        ...
        private void rbDamagedLicense_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblApplicationFees.Text = ClsAppTypes.Find(_GetApplicationTypeID()).Fees.ToString();
        }

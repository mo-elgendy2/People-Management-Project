...
namespace People_Management__full_pro__1set
{
    public partial class frmReleaseDetainedLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            lblApplicationFees.Text = ClsAppTypes.Find((int)clsApplictions.enApplicationType.ReleaseDetainedDrivingLicsense).Fees.ToString();
        ...
        {
            FrmPerDetails frm =
             new FrmPerDetails(ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.DriverInfo.PersonID);
            frm.ShowDialog();
        }

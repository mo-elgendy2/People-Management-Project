...
namespace People_Management__full_pro__1set.Tests
{
    public partial class frmListTestAppointments : Form
    {
        ...
        private void frmListTestAppointments_Load(object sender, EventArgs e)
        {
            ...
            ctrl_DrivingLicenseApplicationInfo1.LoadApplicationinfoBYLocalDrivingAppID(_LocalDrivingLicenseApplicationID);
        ...
        private void btnAddNewAppointment_Click(object sender, EventArgs e)
        {
            ...
            clsLocalDrivingLicenseApplicaton localDrivingLicenseApplication = clsLocalDrivingLicenseApplicaton.FindByLocalDrivingAppLicenseID(_LocalDrivingLicenseApplicationID);

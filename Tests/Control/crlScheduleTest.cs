...
namespace People_Management__full_pro__1set.Tests.Control
{
    public partial class ctrlScheduleTest : UserControl
    {
        ...
        private clsLocalDrivingLicenseApplicaton _LocalDrivingLicenseApplication;
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            _LocalDrivingLicenseApplicationID = LocalDrivingLicenseApplicationID;
            _LocalDrivingLicenseApplication = clsLocalDrivingLicenseApplicaton.FindByLocalDrivingAppLicenseID(_LocalDrivingLicenseApplicationID);
            ...
            {
                lblRetakeAppFees.Text = ClsAppTypes.Find((int)clsApplictions.enApplicationType.RetakeTest).Fees.ToString();
        ...
        {
            if (_Mode == enMode.AddNew && clsLocalDrivingLicenseApplicaton.IsThereAnActiveScheduledTest(_LocalDrivingLicenseApplicationID, _TestTypeID))
            {
        ...
        private bool _HandleRetakeApplication()
        {
            ...
            if (_Mode == enMode.AddNew && _CreationMode == enCreationMode.RetakeTestSchedule)
            {
                ...
                clsApplictions Application = new clsApplictions();

                Application.ApplicantPersonID = _LocalDrivingLicenseApplication.ApplicantPersonID;
                Application.ApplicationDate = DateTime.Now;
                Application.ApplcationTypeId = (int)clsApplictions.enApplicationType.RetakeTest;
                Application.applcatonStatus = clsApplictions.enApplicationStatus.Completed;
                Application.LastStatusDate = DateTime.Now;
                Application.PaidFees = ClsAppTypes.Find((int)clsApplictions.enApplicationType.RetakeTest).Fees;
                Application.CreatByUserId = clsGlobal.CurrentUser.UserID;
        ...
        private void lblRetakeTestAppID_Click(object sender, EventArgs e)
        {
